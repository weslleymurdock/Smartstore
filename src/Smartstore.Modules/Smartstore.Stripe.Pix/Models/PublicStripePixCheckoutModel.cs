...
public class PublicStripeElementsModel : ModelBase
{
    ...
    /// <summary>
    /// <see cref="StripePixPaymentRequest"/> serialized as JSON string.
    /// </summary>
...
public class StripePixPaymentRequest
{
    ...
    /// </summary>
    public StripePixPaymentItem Total { get; set; }
    ...
    /// </summary>
    public List<StripePixPaymentItem> DisplayItems { get; set; } = new();
}

public class StripePixPaymentItem
{
    /// <summary>
